...
# Whisper - E2E Networks Remote Endpoint (OpenAI-compatible ASR)
WHISPER_ENDPOINT=https://infer.e2enetworks.net/project/p-6530/endpoint/is-6356/v1/
...
# Transcription provider & model (OpenAI-compatible)
...
echo "✅ .env file created with ASR endpoint (is-6356) and OpenAI-compatible config"
